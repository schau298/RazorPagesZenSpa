    ...
    public partial class ClientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2021, 10, 25, 14, 27, 50, 102, DateTimeKind.Local).AddTicks(3401), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2021, 10, 25, 14, 27, 50, 115, DateTimeKind.Local).AddTicks(3844), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2021, 10, 25, 14, 27, 50, 115, DateTimeKind.Local).AddTicks(3660), 7 });
