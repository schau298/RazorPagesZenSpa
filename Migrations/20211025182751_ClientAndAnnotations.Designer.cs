...
namespace RazorPages.Migrations
{
    ...
    [Migration("20211025182751_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 25, 14, 27, 50, 102, DateTimeKind.Local).AddTicks(3401),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2021, 10, 25, 14, 27, 50, 115, DateTimeKind.Local).AddTicks(3660),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2021, 10, 25, 14, 27, 50, 115, DateTimeKind.Local).AddTicks(3844),
                            ServicesID = 5
                        });
                });
